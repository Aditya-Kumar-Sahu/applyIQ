...
def build_fixture_scrapers() -> dict[str, object]:
    return {
        "linkedin": FixtureScraper("linkedin"),
        "indeed": FixtureScraper("indeed"),
        "remotive": FixtureScraper("remotive"),
        "wellfound": FixtureScraper("wellfound"),
        "serpapi": FixtureScraper("serpapi"),
    }
