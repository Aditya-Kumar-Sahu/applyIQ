...
async def seed_data():
    ...
    async with db_manager.session() as session:
                ...
                "experience": [
                    {
                        ...
                        "duration_months": 36,
                        "highlights": ["Led development of core API services.", "Optimized database queries for 50% speedup."]
                    }
                ],
                "education": [
                    {
        ...
        match1 = JobMatch(
            ...
            job_id=job1.id,
            match_score=0.92,
            score_breakdown={"skills": 0.95, "experience": 0.88, "semantic_similarity": 0.94, "location_match": 1.0, "seniority_alignment": 0.9, "salary_alignment": 0.85},
        ...
        match2 = JobMatch(
            ...
            job_id=job2.id,
            match_score=0.84,
            score_breakdown={"skills": 0.82, "experience": 0.86, "semantic_similarity": 0.85, "location_match": 0.8, "seniority_alignment": 0.9, "salary_alignment": 0.75},
